...
#DESC="new_gene_internal_shift_failed" PLOTS="NEW_GENE" \
...
DESC="new_gene_internal_shift_67_rpoe_fixed" PLOTS="NEW_GENE" \
...
#DESC="new_gene_internal_shift_ex67_over" PLOTS="NEW_GENE" \
#VARIANT="new_gene_internal_shift" FIRST_VARIANT_INDEX=3 LAST_VARIANT_INDEX=4 \
#NEW_GENES="vioAE_meta" OPERONS="off" \
#CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
#SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=0 N_INIT_SIMS=5 \
#LAUNCHPAD_FILE='/user/home/ig13470/wholecell3/wcm2024/wcEcoli/wholecell/fireworks/my_launchpad.yaml' \
...
#python /user/home/ig13470/wholecell3/wcm2024/wcEcoli/runscripts/fireworks/fw_queue.py
#
#DESC="new_gene_internal_shift_ex1-8_overexpr100" PLOTS="NEW_GENE" \
#VARIANT="new_gene_internal_shift" FIRST_VARIANT_INDEX=1 LAST_VARIANT_INDEX=2 \
#NEW_GENES="vioAE_meta" OPERONS="off" \
#CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
#SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=5 N_INIT_SIMS=5 \
...
#
#DESC="new_gene_internal_shift_ex1-8_overexpr100" PLOTS="NEW_GENE" \
#VARIANT="new_gene_internal_shift" FIRST_VARIANT_INDEX=3 LAST_VARIANT_INDEX=3 \
#NEW_GENES="vioAE_meta" OPERONS="off" \
#CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
#SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=5 N_INIT_SIMS=5 \
#LAUNCHPAD_FILE='/user/home/ig13470/wholecell3/wcm2024/wcEcoli/wholecell/fireworks/my_launchpad.yaml' \
...
#DESC="new_gene_internal_shift_ex1-8_overexpr100" PLOTS="NEW_GENE" \
#VARIANT="new_gene_internal_shift" FIRST_VARIANT_INDEX=5 LAST_VARIANT_INDEX=6 \
#NEW_GENES="vioAE_meta" OPERONS="off" \
#CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
#SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=0 N_INIT_SIMS=5 \
#LAUNCHPAD_FILE='/user/home/ig13470/wholecell3/wcm2024/wcEcoli/wholecell/fireworks/my_launchpad.yaml' \
...
#
#DESC="new_gene_internal_shift_ex1-8_overexpr100" PLOTS="NEW_GENE" \
#VARIANT="new_gene_internal_shift" FIRST_VARIANT_INDEX=7 LAST_VARIANT_INDEX=8 \
#NEW_GENES="vioAE_meta" OPERONS="off" \
#CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
#SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=0 N_INIT_SIMS=5 \
#LAUNCHPAD_FILE='/user/home/ig13470/wholecell3/wcm2024/wcEcoli/wholecell/fireworks/my_launchpad.yaml' \
