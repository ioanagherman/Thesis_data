...
DESC="min_genomes_st2_expr7" PLOTS="NEW_GENE" \
...
DESC="min_genomes_st2_expr7" PLOTS="NEW_GENE" \
VARIANT="gene_knockout_and_knockin" FIRST_VARIANT_INDEX=13 LAST_VARIANT_INDEX=15 \
NEW_GENES="vioAE_meta" OPERONS="off" \
CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=0 N_INIT_SIMS=5 \
LAUNCHPAD_FILE='/user/home/ig13470/wholecell3/wcm2024/wcEcoli/wholecell/fireworks/my_launchpad.yaml' \
...
DESC="min_genomes_st2_expr7" PLOTS="NEW_GENE" \
VARIANT="gene_knockout_and_knockin" FIRST_VARIANT_INDEX=16 LAST_VARIANT_INDEX=18 \
NEW_GENES="vioAE_meta" OPERONS="off" \
CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=0 N_INIT_SIMS=5 \
LAUNCHPAD_FILE='/user/home/ig13470/wholecell3/wcm2024/wcEcoli/wholecell/fireworks/my_launchpad.yaml' \
...
DESC="min_genomes_st2_expr7" PLOTS="NEW_GENE" \
VARIANT="gene_knockout_and_knockin" FIRST_VARIANT_INDEX=19 LAST_VARIANT_INDEX=20 \
NEW_GENES="vioAE_meta" OPERONS="off" \
CACHED_SIM_DATA=0 PARALLEL_PARCA=1 \
SINGLE_DAUGHTERS=1 N_GENS=20 LOG_TO_DISK_EVERY=30 SEED=0 N_INIT_SIMS=5 \
LAUNCHPAD_FILE='/user/home/ig13470/wholecell3/wcm2024/wcEcoli/wholecell/fireworks/my_launchpad.yaml' \
