...
NEW_GENE_EXPRESSION_FACTORS = [0, 4, 5, 6]
NEW_GENE_TRANSLATION_EFFICIENCY_VALUES = [[5,10,2,4,1], [3,9,2,8,1], [7,10,2,6,1]]
...
def new_gene_internal_shift_different_rbs(sim_data, index):
	"""
